        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo site_url('master/menu_form_add/add'); ?>">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm text-capitalize" name="menu" value="<?php echo $test; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputEmail" class="col-sm-2 col-form-label">Menu</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm text-capitalize" name="menu" value="<?php echo $get_menu['menu']; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Url</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm" name="url" value="<?php echo $get_menu['url']; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputNumber" class="col-sm-2 col-form-label">Icon</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm" name="icon" value="<?php echo $get_menu['icon']; ?>" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputNumber" class="col-sm-2 col-form-label">Status</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-sm" name="icon" value="<?php echo $get_menu['is_active'] !== '0' ? 'Active' : 'Deactive'; ?>" readonly>
                    </div>
                </div>
