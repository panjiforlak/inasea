    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo site_url('master/menu_form/add'); ?>">
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Parent</label>
                        <div class="col-sm-5">
                            <select class="form-select form-select-sm select2" name="menu_parent">
                    ...
                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Menu <sup class="text-danger">*</sup></label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-sm text-capitalize" name="menu" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-sm" name="icon" placeholder="ex: bi bi-gear-wide-connected">
                            <small class="fst-italic float-right" style="font-size:10px;">Source: <a target="_blank" href="https://icons.getbootstrap.com/">Bootstrap Icon</a></small>
                        </div>
                    </div>
                    <div class="row mb-0">
                    ...
                    <div class="row">
                        <label for="" class="col-sm-7 col-form-label text-muted fst-italic" style="font-size:10px;"><span class="text-danger">( * )</span> : is required</label>
                    </div>
