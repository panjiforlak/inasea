...
?>
<form method="POST" action="<?php echo site_url('master/system/edit/' . $param2); ?>" enctype="multipart/form-data">
    <div class="form-group" id="thumbnail-picker-area">
        <label class="col-form-label-sm font-weight-bold mb-0" for="">Company Logo</label>
        <div class="input-group">
            <img class="img-thumbnail" src="<?php echo base_url('uploads/system/' . $get_system['company_logo']); ?>" width="65">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control form-control-sm" id="" name="copyright" value="<?php echo $get_system['copyright']; ?>">
    </div>
    <div class="form-group">
        <label class="col-form-label-sm font-weight-bold mb-0" for="">Talk to us</label>
        <textarea class="form-control ckeditor" name="desc_talk_to_us" rows="2"><?php echo $get_system['desc_talk_to_us']; ?></textarea>
    </div>
    <hr class="">
    <center>
