    ...
    <div class="col-xl-12 col-lg-7 ">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-2 d-flex flex-row align-items-center border-bottom-primary justify-content-between">
                ...
                <a href="javascript:void(0);" class="btn btn-sm btn-success shadow add" onclick="ModalAdd('<?php echo site_url('modal/standart/system/system_add/'); ?>', '<?php echo 'Add System'; ?>')"><i class="fas fa-fw fa-plus "></i> Add</a>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img class="img-thumbnail" src="<?php echo base_url('uploads/system/' . $g_sys['company_logo']); ?>" width="50">
                                    </td>
                                    ...
                                    <td class="text-center edit">
                                        <div class="btn-group py-0" role="group" aria-label="Basic example">
                                            <a class="edit" href="javascript:void(0);" onclick="ModalEdit('<?php echo site_url('modal/standart/system/system_edit/' . $g_sys['id']); ?>', '<?php echo 'Edit System'; ?>')">
                                                <button class="btn btn-sm py-0 btn-primary edit" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fas fa-fw fa-edit"></i>
                                                </button>
                                            </a>
                                            <a href="javascript:void(0);" class="delete ml-1" data-href="<?php echo site_url('master/system/delete/' . $g_sys['id']); ?>" data-toggle="modal" data-target="#confirm" data-backdrop="static" data-keyboard="false">
