    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            <div class="filter">
                <a href="<?php echo site_url(); ?>master/work_unit" class="btn btn-sm btn-danger add" style="font-size: 12px;margin-right:20px;">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo site_url('master/work_unit_form/add'); ?>">

                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Code</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-sm text-capitalize" name="unit_code" value="<?php echo 'D' . sprintf("%03s", $data['unit_code']); ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
