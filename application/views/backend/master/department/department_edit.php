...
?>
<form method="POST" action="<?php echo site_url('master/work_unit_form/edit/' . $param2); ?>">


    <div class="row mb-3">
        <label for="inputPassword" class="col-sm-2 col-form-label">Code</label>
        <div class="col-sm-5">
            <input type="text" class="form-control form-control-sm" name="unit_code" value="<?php echo $get['unit_code']; ?>" readonly>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control form-control-sm" name="unit_name" value="<?php echo $get['unit_name']; ?>">
        </div>
    </div>
