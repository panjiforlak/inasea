    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            <div class="filter">
                ...
                <a href="<?php echo site_url(); ?>master/branch" class="btn btn-sm btn-danger add" style="font-size: 12px;margin-right:20px;">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo site_url('master/branch_form/add'); ?>">

                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Code</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-sm text-capitalize" name="branch_code" value="<?php echo 'B' . sprintf("%03s", $data['product_code']); ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-sm" name="branch_phone" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" id="gridCheck1" value="Active" name="status" checked>
