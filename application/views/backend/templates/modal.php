<script type="text/javascript">
    function ModalAdd(url, header) {
        ...
        jQuery('#addscrollable-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url() . 'assets/global/bg-pattern-light.svg'; ?>" /></div>');
    ...
    function ModalEdit(url, header) {
        // SHOWING AJAX PRELOADER IMAGE
        jQuery('#editscrollable-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url() . 'assets/global/bg-pattern-light.svg'; ?>" /></div>');
    ...
    function ModalAddLarge(url, header) {
        // SHOWING AJAX PRELOADER IMAGE
        jQuery('#addscrollablelarge-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url() . 'assets/global/bg-pattern-light.svg'; ?>" /></div>');
    ...
    function ModalEditLarge(url, header) {
        // SHOWING AJAX PRELOADER IMAGE
        jQuery('#editscrollablelarge-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url() . 'assets/global/bg-pattern-light.svg'; ?>" /></div>');
    ...
    function infomodallarge(url, header) {
        // SHOWING AJAX PRELOADER IMAGE
        jQuery('#infomodallarge-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url() . 'assets/global/bg-pattern-light.svg'; ?>" /></div>');
...
<div class="modal fade shadow-md" data-bs-backdrop="false" id="addscrollable-modal" data-keyboard="false" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary-light py-1">
                <div style="font-size: 13px;" class="modal-title text-uppercase" id="scrollableModalTitle">Modal title</div>
...
<!-- Edit -->
<div class="modal fade" id="editscrollable-modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary-light text-dark py-1">
                <div style="font-size: 14px;" class="modal-title text-uppercase font-weight-bold" id="scrollableModalTitle">Modal title</div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<!-- modaladdlarge -->
<div class="modal fade" id="addscrollablelarge-modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
...
<!-- modaleditlarge -->
<div class="modal fade" id="editscrollablelarge-modal" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
...
<!-- info modal large -->
<div class="modal fade" id="infomodallarge-modal" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
...
<!-- Confirm Modal-->
<div class="modal fade mt-5" id="confirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md " role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning-light py-1">
                ...
                <div style="font-size: 13px;" class="modal-title text-uppercase" id="scrollableModalTitle">Confirmation</div>
