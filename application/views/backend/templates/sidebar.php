...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
            ...
            <span class="d-none d-lg-block text-white">PT. Inaseasupply <sup class="text-warning">SIM</sup></span>
        </a>
    ...
    <nav class="header-nav ms-auto">
        ...
        <div class="sticky-top mt-2mr-0" style="position: absolute; top: 0; right: 0;">
            ...
            <?php if ($this->session->flashdata('success')) : ?>
                <div class="toast align-items-center text-bg-success border-0 " style="margin-top: 43px;margin-right:30px;" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body pt-2 pb-2 fw-bold" style="font-size: 12px;">
            ...
            <?php if ($this->session->flashdata('error')) : ?>
                <div class="toast align-items-center text-bg-danger border-0 " style="margin-top: 43px;margin-right:30px" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body pt-2 pb-2 fw-bold" style="font-size: 12px;">
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        <?php foreach ($menu as $m_satuan) : ?>
            <?php if ($this->uri->segment(1) == $m_satuan['menu']) {
                $act = 'active';
                $aria = '';
                $tog = 'show';
            } else {
            ...
            ?>
            <?php if ($m_satuan['id_menu'] == 1 && $m_satuan['id_menu'] == 1 && $m_satuan['menu'] == 'dashboard') : ?>
                ...
                <li class="nav-item <?php echo $act; ?>">
                    <a class="nav-link <?php echo $aria; ?>" href="<?php echo site_url($m_satuan['url']); ?>">
                        ...
                        <span class="text-capitalize"><?php echo $m_satuan['menu']; ?></span>
                    </a>
                </li><!-- End Dashboard Nav -->
            <?php else : ?>
                <?php if ($m_satuan['menu'] !== 'master' && $m_satuan['is_parent'] == 1) : ?>
                    <li class="nav-item <?php echo $act; ?>">
                        <a class="nav-link  <?php echo $aria; ?>" data-bs-target="#components-nav<?php echo $m_satuan['id_menu']; ?>" data-bs-toggle="collapse" href="#">
                            <i class="<?php echo $m_satuan['icon']; ?>"></i><span class="text-capitalize"><?php echo $m_satuan['menu']; ?></span><i class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="components-nav<?php echo $m_satuan['id_menu']; ?>" class="nav-content collapse <?php echo $tog; ?> sidenav-menu-nested" data-bs-parent="#sidebar-nav">
                            <li>
                                <?php foreach ($menu as $m_coll) : ?>
                                    <?php if ($m_coll['menu_parent'] == $m_satuan['id_menu']) : ?>
                                        <?php if ($breadcrumblink1) : ?>
                                            <?php if ($breadcrumblink1 == $m_coll['url']) : ?>
                                                <a href="<?php echo site_url($m_coll['url']); ?>">
                                                    <i class="bi bi-circle-fill"></i><span class="text-capitalize "><b><?php echo $m_coll['menu']; ?></b></span>
                                                </a>
                                            <?php else : ?>
                                                <a href="<?php echo site_url($m_coll['url']); ?>">
                                                    <i class="bi bi-circle"></i><span class="text-capitalize"><?php echo $m_coll['menu']; ?></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php else : ?>
                ...
                <?php elseif ($m_satuan['menu_parent'] == 0 && $m_satuan['menu'] !== 'master') : ?>
                    <li class="nav-item <?php echo $act; ?>">
    ...
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                ...
                <?php if ($breadcrumb2) : ?>
                    <li class="breadcrumb-item"><a href="<?php echo site_url() . '' . $breadcrumblink1; ?>"><?php echo $breadcrumb1; ?></a></li>
