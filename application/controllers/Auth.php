        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['role_id'] == 1) {
                        $this->session->set_flashdata('success', 'Welcome to Sejahtera 7 management system!<br> You are logged in as : <b>Super Admin</b>');
                        redirect('dashboard');
                    } else {
                        // Admin,Sales,dll
                        $this->session->set_flashdata('success', 'Welcome to Sejahtera 7 management system!<br> You are logged in as : <b>Admin</b>');
                        redirect('dashboard');
                    }
                } else {
